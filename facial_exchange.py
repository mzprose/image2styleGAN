...
import argparse
import torch
torch.cuda.current_device()  # cuda runtime error:添加语句
...
def main():
     ...
     parser.add_argument('--weight_file',default="weight_files/pytorch/karras2019stylegan-ffhq-1024x1024.pkl",type=str)
